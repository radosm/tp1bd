...
create table pasa_por(vue_numero int,orden int,aer_codigo char(3),tiempo_de_vuelo float,tiempo_de_escala float);
...
insert into pasa_por values (1109,1,'AEP',null,1);
insert into pasa_por values (1109,2,'ROS',1,1);
insert into pasa_por values (1109,3,'MDQ',1,1);
insert into pasa_por values (1109,4,'CBA',1,null);

insert into pasa_por values (1110,1,'AEP',null,1);
insert into pasa_por values (1110,2,'MDQ',1,1);
insert into pasa_por values (1110,3,'CBA',2,null);

insert into pasa_por values (1111,1,'EZE',null,1);
insert into pasa_por values (1111,2,'MDQ',1,1);
insert into pasa_por values (1111,3,'MZA',2,null);
